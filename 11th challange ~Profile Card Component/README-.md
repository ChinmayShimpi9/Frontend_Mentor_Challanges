...
In these challange we are free to use flexbox or grid or all the other properties and the challange is simple to create the [Profile Card Component].
Which includes the card which will display image and the some info about the profile and there are social info about followers,likes and photos.


### Links

- Live Site URL: (https://theprofilecardcomponent.netlify.app/)
...
4. And how to manage the image in the center using the positions.
